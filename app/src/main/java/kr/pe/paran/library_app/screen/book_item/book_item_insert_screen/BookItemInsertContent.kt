...
@Composable
fun BookItemInsertContent(
    bookItemData: BookItemData = BookItemData(),
    onClickSave: (BookItemData) -> Unit,
    ...
    Logcat.i(":::::::::::::::::>${bookItemData.toString()} :: ${bookItemData.isNotEmpty()}")
    LazyColumn(
        modifier = Modifier
            .padding(8.dp)
    ) {
